...
/**
 * Immutable value object representing mesh primitive.
 */
...
{
	/**
	 * Merges primitives which share one material into a single indexed primitive.
	 * @param primitives the primitives to merge.
	 * @return the merged primitive.
	 */
	...
	/**
	 * Appends values from a source buffer without changing its position.
	...
	/**
	 * Reads one unsigned index from a primitive.
	 * @param primitive the source primitive.
